...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_jquery_ui_ui_widgets_datepicker_js__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_magnific_popup_dist_jquery_magnific_popup_min_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_magnific_popup_dist_jquery_magnific_popup_min_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_magnific_popup_dist_jquery_magnific_popup_min_js__);

window.$ = window.jQuery = __WEBPACK_IMPORTED_MODULE_0_jquery___default.a;


window.swal = __WEBPACK_IMPORTED_MODULE_1_sweetalert___default.a;
    ...
    $(function () {
        ...
        var deliveryCalculator = {
            ...
            showModal: function showModal() {
                ...
                modal.find('.input-from').html(self.optionFrom.charAt(0).toUpperCase() + self.optionFrom.substr(1).toLowerCase());
                modal.find('.input-to').html(self.optionTo.charAt(0).toUpperCase() + self.optionTo.substr(1).toLowerCase());
            ...
            calcPrice: function calcPrice() {
                ...
                var fastCoeff = function fastCoeff() {
            ...
            Map: {
                ...
                addMarker: function addMarker(place, message, icon) {
                    var geo;
                ...
                checkForPlaces: function checkForPlaces() {
                ...
                buildRoute: function buildRoute() {
                    ...
                    ymaps.route([deliveryCalculator.Map.placeFrom, deliveryCalculator.Map.placeTo]).then(function (route) {
